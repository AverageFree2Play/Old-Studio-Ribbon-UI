...
2. Download the json files in the `CustomRibbonTabs` folder from the repository and drop all (or the ones you would like) .json file(s) inside your `CustomRibbonTabs` folder.
3. Reload the custom tabs through the Manage Tabs menu, and they should all appear. After that, you can reorder or disable some of them if you wish.
